...
if __name__== '__main__':
    test = JobInformation()
    print(test)
    data = json.dumps(test, cls=JobInformation.Encoder)
    resu = json.loads(data, cls=JobInformation.Decoder)
    print(resu)

    test_list = [JobInformation(),JobInformation(),JobInformation()]
    print(test_list)
    data_list = json.dumps(test_list, cls=JobInformation.Encoder)
    resu_list = json.loads(data_list, cls=JobInformation.Decoder)
    print(resu_list)